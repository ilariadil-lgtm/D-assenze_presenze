    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Utilizzato per il login', max_length=254, unique=True, verbose_name='Email')),
                ('role', models.CharField(choices=[('ADMIN', 'Amministratore'), ('PARTICIPANT', 'Partecipante')], default='PARTICIPANT', max_length=20, verbose_name='Ruolo')),
